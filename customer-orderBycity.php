...
require "connection.php";
   $query= "select * from Customers order by city asc";
         ...
         <div class="panel panel-danger spaceabove">           
           ...
           <table class="table">
             <tr>
               ...
               <th>Email</th>
               <th>Address</th>
               <th><a href="customer-orderBycity.php">City<span class="glyphicon glyphicon-arrow-down" aria-hidden="true"></span></th>
               <th><a href="customer-orderBycountry.php">Country</th>
             </tr>
             <?php    
