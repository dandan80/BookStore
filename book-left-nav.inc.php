<div class="rail">
   ...
   <li class="nav-header">Knowledge</li> 
      <li><a href="book-list.php"><span class="glyphicon glyphicon-book"></span> Catalog</a></li>
      <li><a href="customer-list.php"><span class="glyphicon glyphicon-user"></span> Customers</a></li>
